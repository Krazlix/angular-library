...
@Component({
  selector: "app-root",
  standalone: true,
  imports: [RouterOutlet, BreadCrumbComponent, ModalComponent],
...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.carouselItems = [
      new Carousel("/autumn.jpg", "description", 2000),
      new Carousel("./vietnam.jpg", "description2", 3000),
      new Carousel("train.jpg", "description3", 5000),
    ];
  }
}
